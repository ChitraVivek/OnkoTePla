...
{
	public class PatientUpdatedNotification : NetworkMessageBase
	{
		public PatientUpdatedNotification (Patient patient, ConnectionSessionId sessionId)
		...
		public static PatientUpdatedNotification Parse (string s)
		{
			...
			var isHidden   = bool.Parse(patientData[5]);
			
			return new PatientUpdatedNotification(new Patient(name, birthday, alive, id, externalId, isHidden), sessionId);
		}
	}
}